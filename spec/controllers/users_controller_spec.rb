...
describe UsersController do
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "as an admin user" do
      ...
      it "should have an error message" do
        delete :destroy, :id => @admin
        flash[:errors].should =~ /cannot destroy an admin/
      end
  ...
  describe "GET 'index'" do
    ...
    describe "for signed-in users" do
      ...
      it "should not have a delete option for non-admin users" do
        get :index
    ...
    describe "as an admin user" do
      ...
      it "should have a delete option for admin users" do
        get :index
  ...
  describe "POST 'create'" do
    ...
    describe "failure" do
      ...
      it "should reset the password and password_confirmation fields" do
